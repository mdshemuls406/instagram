    ...
    def create_account(self, identity, signup_code):
        ...
        try:
            ...
            if '"account_created":true' in response.text:
                ...
                # --- CHROME BROWSER COOKIE FORMATTING ---
                # Adding standard Chrome/Client-side cookies to make it look 100% like a real browser export
                client_cookies = {
                    "wd": f"{random.choice([360, 390, 412, 428])}x{random.choice([767, 844, 915, 926])}",
                ...
                cookie_string = "; ".join([f"{str(k)}={str(v)}" for k, v in cookies_dict.items()])
                # ----------------------------------------
