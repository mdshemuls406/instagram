...
class InstagramCreator:
    ...
    # Password setting shared across all threads
    ...
    def create_account(self, identity, signup_code):
        ...
        try:
            ...
            if '"account_created":true' in response.text:
                ...
                # Fetching Homepage to construct perfect mobile Chrome cookie
                hp_headers = {
                    'User-Agent': self.st4_user_agent,
                ...
                # Extract ds_user_id from sessionid if missing
                ...
                # Setup specific required mobile cookies if missing
